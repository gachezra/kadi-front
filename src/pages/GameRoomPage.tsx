...
export const GameRoomPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <Modal isOpen={showSuitSelector} onClose={() => setShowSuitSelector(false)} title="Choose Suit">{Object.entries(CARD_SUITS).map(([suit, symbol]) => <Button key={suit} variant="primary" onClick={() => handleSuitSelection(suit)} className="p-4 text-2xl">{symbol} {suit.charAt(0).toUpperCase() + suit.slice(1)}</Button>)}</Modal>
